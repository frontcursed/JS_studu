// изменение состояние => проверить наличие обработчика func
//subscriber, listener, handler
// формирует специальный объект (info about event)
// func (e)
